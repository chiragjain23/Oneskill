...
<div id="Questions" >
<center id="c">
<img src="images/determine.jpg" alt="optimus" height="267px" width="600px" />
<?php 
...
<form style="margin-top:25px;" action="determine_numbers.php" method="post">
Answer:<input name="ans" type="text" style="font-family:'Buxton Sketch';font-size:18px;" size="30" />
<input type="hidden" name="qno" value="6" />
