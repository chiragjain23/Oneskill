...
<div id="Questions" >
<center id="c">
<img src="images/collage.jpg" alt="optimus" height="267px" width="600px" />
<?php 
...
{ 
	...
	header('location:Robert_George_and_Who.php'); 
	}
mysql_close($con);
...
<form style="margin-top:25px;" action="Robert_George_and_Who.php" method="post">
Answer:<input name="ans" type="text" style="font-family:'Buxton Sketch';font-size:18px;" size="30" />
<input type="hidden" name="qno" value="11" />
