...
<div id="Questions" >
<center id="c">
<img src="images/play_with_numbers.png" alt="" height="175px" width="400px" />
<?php 
...
{ 
	...
	$result=mysql_query($sql,$con);
	header('location:aka_muse.php');
	
}
else {
	header('location:resting.php'); 
	}
mysql_close($con);
...
<form style="margin-top:25px;" action="resting.php" method="post">
Answer:<input name="ans" type="text" style="font-family:'Buxton Sketch';font-size:18px;" size="30" />
<input type="hidden" name="qno" value="8" />
