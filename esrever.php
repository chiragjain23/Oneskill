...
<div id="leaderboard">
<table width="100%"><tr  id="level"><th>LEVEL 1</th></tr><tr><td id="board">LEADERBOARD</td></tr><tr>
<td>
...
<div id="Questions" >
<center id="c">
<img src="images/Neo.jpg" alt="optimus" height="267px" width="600px" />
<?php 
...
<form style="margin-top:25px;" action="esrever.php" method="post">
